subroutine print_RHF(nBas,nO,e,C,ENuc,ET,EV,EJ,Ex,EHF)
      ...
      write(outfile,'(A50)')           '---------------------------------------'
      write(outfile,'(A32,1X,F24.16)') ' One-electron energy  ',ET + EV
      write(outfile,'(A32,1X,F24.16)') ' Kinetic      energy  ',ET
      write(outfile,'(A32,1X,F24.16)') ' Potential    energy  ',EV
      write(outfile,'(A50)')           '---------------------------------------'
      write(outfile,'(A32,1X,F24.16)') ' Two-electron energy  ',EJ + Ex
      write(outfile,'(A32,1X,F24.16)') ' Coulomb      energy  ',EJ
      write(outfile,'(A32,1X,F24.16)') ' Exchange     energy  ',Ex
      write(outfile,'(A50)')           '---------------------------------------'
      write(outfile,'(A32,1X,F24.16)') ' Electronic   energy  ',EHF
      write(outfile,'(A32,1X,F24.16)') ' Nuclear   repulsion  ',ENuc
      ...
      write(outfile,'(A50)')           '---------------------------------------'
      write(outfile,'(A36,F24.16)')     ' Potential energy        :',(EV+EJ+Ex+ENuc)
      write(outfile,'(A36,F24.16)')     ' Kinetic   energy        :', ET
      write(outfile,'(A36,F24.16)')     ' Virial    theorem (-V/T):',-(EV+EJ+Ex+ENuc)/ET
      write(outfile,'(A50)')           '---------------------------------------'
      write(outfile,*)
