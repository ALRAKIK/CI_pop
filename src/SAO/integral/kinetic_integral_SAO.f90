subroutine kinetic_integral_ss_SAO(r1,r2,AO1,AO2,S_ss_normal)
...
end subroutine kinetic_integral_ss_SAO

subroutine kinetic_integral_sp_SAO(r1,r2,AO1,AO2,S_sp_normal)
...
end subroutine kinetic_integral_sp_SAO

subroutine kinetic_integral_pp_SAO(r1,r2,AO1,AO2,S_pp_normal)
...
end subroutine kinetic_integral_pp_SAO