subroutine Tori3D(n_atoms,number_of_functions,atoms,AO,geometry,OV,K,NA,ERI,c_ERI_a)
      ...
      if (c_ERI_a) then 
            call ERI_integral_toroidal_3D_sparse(n_atoms,geometry,number_of_functions,atoms)
      else 
...
subroutine Tori3D_sparse(n_atoms,number_of_functions,atoms,AO,geometry,OV,K,NA)
