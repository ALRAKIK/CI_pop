...
subroutine SAO_kinetic_matrix_toroidal_n(number_of_atoms,number_of_functions,atoms,AO,SAO_kinetic)
      ...
      double precision,intent(out) :: SAO_kinetic(number_of_functions,number_of_functions)
      ...
      do k = 1 , number_of_functions
        do k_prime  = 1 , number_of_functions 
          do mu = 1 , number_of_functions 
            SAO_kinetic(k,k_prime) = SAO_kinetic(k,k_prime) + Kronecker_delta(k-k_prime) * dcos(((2*pi)/number_of_functions)*(k_prime-1)*(mu-1)) * kinetic(1,mu)
          end do 
        end do 
      end do 
...
end subroutine SAO_kinetic_matrix_toroidal_n