...
subroutine SAO_nuclear_attraction_matrix_toroidal_1D_n(number_of_atoms,number_of_functions,geometry,atoms,AO,SAO_NA)
      ...
      double precision,intent(out)  :: SAO_NA(number_of_functions,number_of_functions)
      ...
      do k = 1 , number_of_functions 
        do k_prime  = 1 , number_of_functions 
          do mu = 1 , number_of_functions 
            SAO_NA(k,k_prime) = SAO_NA(k,k_prime) + Kronecker_delta(k-k_prime) * dcos(((2*pi)/number_of_functions)*(k_prime-1)*(mu-1)) * NA(1,mu)
          end do 
        end do 
      end do 
...
end subroutine SAO_nuclear_attraction_matrix_toroidal_1D_n