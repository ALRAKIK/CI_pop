subroutine integrate_ERI_sum(pattern_id,p,q,p_x,q_x,phi,xpA,xpB,xqC,xqD,xa,xb,xc,xd,xp,xq &
     ...
     &                                                                 ,za,zb,zc,zd,zp,zq,result)
      ...
      double precision                     :: I_A(0:100000)
      double precision                     :: I_B(0:100000)
      double precision                     :: I_C(0:100000)
      ...
      ! termAn = I_A(n)
      ! termBn = I_B(n)
      ! term   = termAn * termBn * I_C(n) * current_term
      ...
      ! do n   = 1 , Nmax
      ! termAn = I_A(n)
      ! termBn = inv_ax*((-0.5*I_dp*cxqd + 0.5*sxqd)*I_B(Abs(n - 1)) + (0.5*I_dp*cxqd + 0.5*sxqd)*I_B(n + 1))
      ! term   = termAn * termBn * I_C(n) * current_term
      !   if (abs(term) < eps * dabs(sum) ) exit
      !     sum = sum + 2.d0 * real(term) * const
      !     current_term = current_term * expo_term
      ...
      ! do n   = 1 , Nmax
      ! termAn = I_A(n)
      ! termBn = inv_ax*((-0.5*I_dp*cxqc + 0.5*sxqc)*I_B(Abs(n - 1)) + (0.5*I_dp*cxqc + 0.5*sxqc)*I_B(n + 1))
      ! term   = termAn * termBn * I_C(n) * current_term
      !   if (abs(term) < eps * dabs(sum) ) exit
      !     sum = sum + 2.d0 * real(term) * const
      !     current_term = current_term * expo_term
      ...
      ! n = 0
      ! const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
      ! sum    = (inv_ax2*((-0.25*cxqc*cxqd + 0.25*sxqc*sxqd)*I_B(n + 2) + (-0.25*cxqc*cxqd + 0.25*sxqc*sxqd)*I_B(Abs(n - 2)) + (0.5*cxqc*cxqd + 0.5*sxqc*sxqd)*I_B(n))*I_A(n)) * I_C(n) * const
      ! do n   = 1 , Nmax
      ! termAn = I_A(n)
      ! termBn = inv_ax2*(0.25*I_dp*cxqc*sxqd*I_B(n + 2) - 0.25*I_dp*cxqc*sxqd*I_B(Abs(n - 2)) + 0.25*I_dp*cxqd*sxqc*I_B(n + 2) - 0.25*I_dp*cxqd*sxqc*I_B(Abs(n - 2)) - 0.25*cxqc*cxqd*I_B(n + 2) - 0.25*cxqc*cxqd*I_B(Abs(n - 2)) + 0.25*sxqc*sxqd*I_B(n + 2) + 0.25*sxqc*sxqd*I_B(Abs(n - 2)) + (0.5*cxqc*cxqd + 0.5*sxqc*sxqd)*I_B(n))
      ! term   = termAn * termBn * I_C(n) * current_term
      !   if (abs(term) < eps * dabs(sum) ) exit
      !     sum = sum + 2.d0 * real(term) * const
      !     current_term = current_term * expo_term
      ...
      ! do n   = 1 , Nmax
      ! termAn = inv_ax*((-0.5*I_dp*cxpb + 0.5*sxpb)*I_A(n + 1) + (0.5*I_dp*cxpb + 0.5*sxpb)*I_A(Abs(n - 1)))
      ! termBn = I_B(n)
      ! term   = termAn * termBn * I_C(n) * current_term
      !   if (abs(term) < eps * dabs(sum) ) exit
      !     sum = sum + 2.d0 * real(term) * const
      ...
      ! n = 0
      ! const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
      ! sum    = (inv_ax**2*((0.25*sxpb*sxqd*I_B(n + 1) + 0.25*sxpb*sxqd*I_B(Abs(n - 1)))*I_A(n + 1) + (0.25*sxpb*sxqd*I_B(n + 1) + 0.25*sxpb*sxqd*I_B(Abs(n - 1)))*I_A(Abs(n - 1)))) * I_C(n) * const
      ! do n   = 1 , Nmax
      ! termAn = inv_ax*((-0.5*I_dp*cxpb + 0.5*sxpb)*I_A(n + 1) + (0.5*I_dp*cxpb + 0.5*sxpb)*I_A(Abs(n - 1)))
      ! termBn = inv_ax*((-0.5*I_dp*cxqd + 0.5*sxqd)*I_B(Abs(n - 1)) + (0.5*I_dp*cxqd + 0.5*sxqd)*I_B(n + 1))
      ! term   = termAn * termBn * I_C(n) * current_term
      ...
      ! n = 0
      ! const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
      ! sum    = (inv_ax**2*((0.25*sxpb*sxqc*I_B(n + 1) + 0.25*sxpb*sxqc*I_B(Abs(n - 1)))*I_A(n + 1) + (0.25*sxpb*sxqc*I_B(n + 1) + 0.25*sxpb*sxqc*I_B(Abs(n - 1)))*I_A(Abs(n - 1)))) * I_C(n) * const
      ! do n   = 1 , Nmax
      ! termAn = inv_ax*((-0.5*I_dp*cxpb + 0.5*sxpb)*I_A(n + 1) + (0.5*I_dp*cxpb + 0.5*sxpb)*I_A(Abs(n - 1)))
      ! termBn = inv_ax*((-0.5*I_dp*cxqc + 0.5*sxqc)*I_B(Abs(n - 1)) + (0.5*I_dp*cxqc + 0.5*sxqc)*I_B(n + 1))
      ! term   = termAn * termBn * I_C(n) * current_term
      ...
      ! n = 0
      ! const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
      ! sum    = (inv_ax*inv_ax2*(((-0.125*cxqc*cxqd*sxpb + 0.125*sxpb*sxqc*sxqd)*I_B(n + 2) + (-0.125*cxqc*cxqd*sxpb + 0.125*sxpb*sxqc*sxqd)*I_B(Abs(n - 2)))*I_A(n + 1) + ((-0.125*cxqc*cxqd*sxpb + 0.125*sxpb*sxqc*sxqd)*I_B(n + 2) + (-0.125*cxqc*cxqd*sxpb + 0.125*sxpb*sxqc*sxqd)*I_B(Abs(n - 2)))*I_A(Abs(n - 1)) + ((0.25*cxqc*cxqd*sxpb + 0.25*sxpb*sxqc*sxqd)*I_A(n + 1) + (0.25*cxqc*cxqd*sxpb + 0.25*sxpb*sxqc*sxqd)*I_A(Abs(n - 1)))*I_B(n))) * I_C(n) * const
      ! do n   = 1 , Nmax
      ! termAn = inv_ax*((-0.5*I_dp*cxpb + 0.5*sxpb)*I_A(n + 1) + (0.5*I_dp*cxpb + 0.5*sxpb)*I_A(Abs(n - 1)))
      ! termBn = inv_ax2*(0.25*I_dp*cxqc*sxqd*I_B(n + 2) - 0.25*I_dp*cxqc*sxqd*I_B(Abs(n - 2)) + 0.25*I_dp*cxqd*sxqc*I_B(n + 2) - 0.25*I_dp*cxqd*sxqc*I_B(Abs(n - 2)) - 0.25*cxqc*cxqd*I_B(n + 2) - 0.25*cxqc*cxqd*I_B(Abs(n - 2)) + 0.25*sxqc*sxqd*I_B(n + 2) + 0.25*sxqc*sxqd*I_B(Abs(n - 2)) + (0.5*cxqc*cxqd + 0.5*sxqc*sxqd)*I_B(n))
      ! term   = termAn * termBn * I_C(n) * current_term
      ...
      ! do n   = 1 , Nmax
      ! termAn = inv_ax*((-0.5*I_dp*cxpa + 0.5*sxpa)*I_A(n + 1) + (0.5*I_dp*cxpa + 0.5*sxpa)*I_A(Abs(n - 1)))
      ! termBn = I_B(n)
      ! term   = termAn * termBn * I_C(n) * current_term
      !   if (abs(term) < eps * dabs(sum) ) exit
      !     sum = sum + 2.d0 * real(term) * const
      ...
      ! n = 0
      ! const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
      ! sum    = (inv_ax**2*((0.25*sxpa*sxqd*I_B(n + 1) + 0.25*sxpa*sxqd*I_B(Abs(n - 1)))*I_A(n + 1) + (0.25*sxpa*sxqd*I_B(n + 1) + 0.25*sxpa*sxqd*I_B(Abs(n - 1)))*I_A(Abs(n - 1)))) * I_C(n) * const
      ! do n   = 1 , Nmax
      ! termAn = inv_ax*((-0.5*I_dp*cxpa + 0.5*sxpa)*I_A(n + 1) + (0.5*I_dp*cxpa + 0.5*sxpa)*I_A(Abs(n - 1)))
      ! termBn = inv_ax*((-0.5*I_dp*cxqd + 0.5*sxqd)*I_B(Abs(n - 1)) + (0.5*I_dp*cxqd + 0.5*sxqd)*I_B(n + 1))
      ! term   = termAn * termBn * I_C(n) * current_term
      ...
      ! n = 0
      ! const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
      ! sum    = (inv_ax**2*((0.25*sxpa*sxqc*I_B(n + 1) + 0.25*sxpa*sxqc*I_B(Abs(n - 1)))*I_A(n + 1) + (0.25*sxpa*sxqc*I_B(n + 1) + 0.25*sxpa*sxqc*I_B(Abs(n - 1)))*I_A(Abs(n - 1)))) * I_C(n) * const
      ! do n   = 1 , Nmax
      ! termAn = inv_ax*((-0.5*I_dp*cxpa + 0.5*sxpa)*I_A(n + 1) + (0.5*I_dp*cxpa + 0.5*sxpa)*I_A(Abs(n - 1)))
      ! termBn = inv_ax*((-0.5*I_dp*cxqc + 0.5*sxqc)*I_B(Abs(n - 1)) + (0.5*I_dp*cxqc + 0.5*sxqc)*I_B(n + 1))
      ! term   = termAn * termBn * I_C(n) * current_term
      ...
      ! n = 0
      ! const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
      ! sum    = (inv_ax*inv_ax2*(((-0.125*cxqc*cxqd*sxpa + 0.125*sxpa*sxqc*sxqd)*I_B(n + 2) + (-0.125*cxqc*cxqd*sxpa + 0.125*sxpa*sxqc*sxqd)*I_B(Abs(n - 2)))*I_A(n + 1) + ((-0.125*cxqc*cxqd*sxpa + 0.125*sxpa*sxqc*sxqd)*I_B(n + 2) + (-0.125*cxqc*cxqd*sxpa + 0.125*sxpa*sxqc*sxqd)*I_B(Abs(n - 2)))*I_A(Abs(n - 1)) + ((0.25*cxqc*cxqd*sxpa + 0.25*sxpa*sxqc*sxqd)*I_A(n + 1) + (0.25*cxqc*cxqd*sxpa + 0.25*sxpa*sxqc*sxqd)*I_A(Abs(n - 1)))*I_B(n))) * I_C(n) * const
      ! do n   = 1 , Nmax
      ! termAn = inv_ax*((-0.5*I_dp*cxpa + 0.5*sxpa)*I_A(n + 1) + (0.5*I_dp*cxpa + 0.5*sxpa)*I_A(Abs(n - 1)))
      ! termBn = inv_ax2*(0.25*I_dp*cxqc*sxqd*I_B(n + 2) - 0.25*I_dp*cxqc*sxqd*I_B(Abs(n - 2)) + 0.25*I_dp*cxqd*sxqc*I_B(n + 2) - 0.25*I_dp*cxqd*sxqc*I_B(Abs(n - 2)) - 0.25*cxqc*cxqd*I_B(n + 2) - 0.25*cxqc*cxqd*I_B(Abs(n - 2)) + 0.25*sxqc*sxqd*I_B(n + 2) + 0.25*sxqc*sxqd*I_B(Abs(n - 2)) + (0.5*cxqc*cxqd + 0.5*sxqc*sxqd)*I_B(n))
      ! term   = termAn * termBn * I_C(n) * current_term
      ...
      ! n = 0
      ! const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
      ! sum    = (inv_ax2*((-0.25*cxpa*cxpb + 0.25*sxpa*sxpb)*I_A(n + 2) + (-0.25*cxpa*cxpb + 0.25*sxpa*sxpb)*I_A(Abs(n - 2)) + (0.5*cxpa*cxpb + 0.5*sxpa*sxpb)*I_A(n))*I_B(n)) * I_C(n) * const
      ! do n   = 1 , Nmax
      ! termAn = inv_ax2*(-0.25*I_dp*cxpa*sxpb*I_A(n + 2) + 0.25*I_dp*cxpa*sxpb*I_A(Abs(n - 2)) - 0.25*I_dp*cxpb*sxpa*I_A(n + 2) + 0.25*I_dp*cxpb*sxpa*I_A(Abs(n - 2)) - 0.25*cxpa*cxpb*I_A(n + 2) - 0.25*cxpa*cxpb*I_A(Abs(n - 2)) + 0.25*sxpa*sxpb*I_A(n + 2) + 0.25*sxpa*sxpb*I_A(Abs(n - 2)) + (0.5*cxpa*cxpb + 0.5*sxpa*sxpb)*I_A(n))
      ! termBn = I_B(n)
      ! term   = termAn * termBn * I_C(n) * current_term
      !   if (abs(term) < eps * dabs(sum) ) exit
      !     sum = sum + 2.d0 * real(term) * const
      ...
      ! n = 0
      ! const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
      ! sum    = (inv_ax*inv_ax2*(((-0.125*cxpa*cxpb*sxqd + 0.125*sxpa*sxpb*sxqd)*I_A(n + 2) + (-0.125*cxpa*cxpb*sxqd + 0.125*sxpa*sxpb*sxqd)*I_A(Abs(n - 2)))*I_B(n + 1) + ((-0.125*cxpa*cxpb*sxqd + 0.125*sxpa*sxpb*sxqd)*I_A(n + 2) + (-0.125*cxpa*cxpb*sxqd + 0.125*sxpa*sxpb*sxqd)*I_A(Abs(n - 2)))*I_B(Abs(n - 1)) + ((0.25*cxpa*cxpb*sxqd + 0.25*sxpa*sxpb*sxqd)*I_B(n + 1) + (0.25*cxpa*cxpb*sxqd + 0.25*sxpa*sxpb*sxqd)*I_B(Abs(n - 1)))*I_A(n))) * I_C(n) * const
      ! do n   = 1 , Nmax
      ! termAn = inv_ax2*(-0.25*I_dp*cxpa*sxpb*I_A(n + 2) + 0.25*I_dp*cxpa*sxpb*I_A(Abs(n - 2)) - 0.25*I_dp*cxpb*sxpa*I_A(n + 2) + 0.25*I_dp*cxpb*sxpa*I_A(Abs(n - 2)) - 0.25*cxpa*cxpb*I_A(n + 2) - 0.25*cxpa*cxpb*I_A(Abs(n - 2)) + 0.25*sxpa*sxpb*I_A(n + 2) + 0.25*sxpa*sxpb*I_A(Abs(n - 2)) + (0.5*cxpa*cxpb + 0.5*sxpa*sxpb)*I_A(n))
      ! termBn = inv_ax*((-0.5*I_dp*cxqd + 0.5*sxqd)*I_B(Abs(n - 1)) + (0.5*I_dp*cxqd + 0.5*sxqd)*I_B(n + 1))
      ! term   = termAn * termBn * I_C(n) * current_term
      ...
      ! n = 0
      ! const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
      ! sum    = (inv_ax*inv_ax2*(((-0.125*cxpa*cxpb*sxqc + 0.125*sxpa*sxpb*sxqc)*I_A(n + 2) + (-0.125*cxpa*cxpb*sxqc + 0.125*sxpa*sxpb*sxqc)*I_A(Abs(n - 2)))*I_B(n + 1) + ((-0.125*cxpa*cxpb*sxqc + 0.125*sxpa*sxpb*sxqc)*I_A(n + 2) + (-0.125*cxpa*cxpb*sxqc + 0.125*sxpa*sxpb*sxqc)*I_A(Abs(n - 2)))*I_B(Abs(n - 1)) + ((0.25*cxpa*cxpb*sxqc + 0.25*sxpa*sxpb*sxqc)*I_B(n + 1) + (0.25*cxpa*cxpb*sxqc + 0.25*sxpa*sxpb*sxqc)*I_B(Abs(n - 1)))*I_A(n))) * I_C(n) * const
      ! do n   = 1 , Nmax
      ! termAn = inv_ax2*(-0.25*I_dp*cxpa*sxpb*I_A(n + 2) + 0.25*I_dp*cxpa*sxpb*I_A(Abs(n - 2)) - 0.25*I_dp*cxpb*sxpa*I_A(n + 2) + 0.25*I_dp*cxpb*sxpa*I_A(Abs(n - 2)) - 0.25*cxpa*cxpb*I_A(n + 2) - 0.25*cxpa*cxpb*I_A(Abs(n - 2)) + 0.25*sxpa*sxpb*I_A(n + 2) + 0.25*sxpa*sxpb*I_A(Abs(n - 2)) + (0.5*cxpa*cxpb + 0.5*sxpa*sxpb)*I_A(n))
      ! termBn = inv_ax*((-0.5*I_dp*cxqc + 0.5*sxqc)*I_B(Abs(n - 1)) + (0.5*I_dp*cxqc + 0.5*sxqc)*I_B(n + 1))
      ! term   = termAn * termBn * I_C(n) * current_term
      ...
      ! n = 0
      ! const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
      ! sum    = (inv_ax2**2*(((-0.125*cxpa*cxpb*cxqc*cxqd - 0.125*cxpa*cxpb*sxqc*sxqd + 0.125*cxqc*cxqd*sxpa*sxpb + 0.125*sxpa*sxpb*sxqc*sxqd)*I_A(n + 2) + (-0.125*cxpa*cxpb*cxqc*cxqd - 0.125*cxpa*cxpb*sxqc*sxqd + 0.125*cxqc*cxqd*sxpa*sxpb + 0.125*sxpa*sxpb*sxqc*sxqd)*I_A(Abs(n - 2)))*I_B(n) + ((0.0625*cxpa*cxpb*cxqc*cxqd - 0.0625*cxpa*cxpb*sxqc*sxqd - 0.0625*cxqc*cxqd*sxpa*sxpb + 0.0625*sxpa*sxpb*sxqc*sxqd)*I_B(n + 2) + (0.0625*cxpa*cxpb*cxqc*cxqd - 0.0625*cxpa*cxpb*sxqc*sxqd - 0.0625*cxqc*cxqd*sxpa*sxpb + 0.0625*sxpa*sxpb*sxqc*sxqd)*I_B(Abs(n - 2)))*I_A(n + 2) + ((0.0625*cxpa*cxpb*cxqc*cxqd - 0.0625*cxpa*cxpb*sxqc*sxqd - 0.0625*cxqc*cxqd*sxpa*sxpb + 0.0625*sxpa*sxpb*sxqc*sxqd)*I_B(n + 2) + (0.0625*cxpa*cxpb*cxqc*cxqd - 0.0625*cxpa*cxpb*sxqc*sxqd - 0.0625*cxqc*cxqd*sxpa*sxpb + 0.0625*sxpa*sxpb*sxqc*sxqd)*I_B(Abs(n - 2)))*I_A(Abs(n - 2)) + ((-0.125*cxpa*cxpb*cxqc*cxqd + 0.125*cxpa*cxpb*sxqc*sxqd - 0.125*cxqc*cxqd*sxpa*sxpb + 0.125*sxpa*sxpb*sxqc*sxqd)*I_B(n + 2) + (-0.125*cxpa*cxpb*cxqc*cxqd + 0.125*cxpa*cxpb*sxqc*sxqd - 0.125*cxqc*cxqd*sxpa*sxpb + 0.125*sxpa*sxpb*sxqc*sxqd)*I_B(Abs(n - 2)) + (0.25*cxpa*cxpb*cxqc*cxqd + 0.25*cxpa*cxpb*sxqc*sxqd + 0.25*cxqc*cxqd*sxpa*sxpb + 0.25*sxpa*sxpb*sxqc*sxqd)*I_B(n))*I_A(n))) * I_C(n) * const
      ! do n   = 1 , Nmax
      ! termAn = inv_ax2*(-0.25*I_dp*cxpa*sxpb*I_A(n + 2) + 0.25*I_dp*cxpa*sxpb*I_A(Abs(n - 2)) - 0.25*I_dp*cxpb*sxpa*I_A(n + 2) + 0.25*I_dp*cxpb*sxpa*I_A(Abs(n - 2)) - 0.25*cxpa*cxpb*I_A(n + 2) - 0.25*cxpa*cxpb*I_A(Abs(n - 2)) + 0.25*sxpa*sxpb*I_A(n + 2) + 0.25*sxpa*sxpb*I_A(Abs(n - 2)) + (0.5*cxpa*cxpb + 0.5*sxpa*sxpb)*I_A(n))
      ! termBn = inv_ax2*(0.25*I_dp*cxqc*sxqd*I_B(n + 2) - 0.25*I_dp*cxqc*sxqd*I_B(Abs(n - 2)) + 0.25*I_dp*cxqd*sxqc*I_B(n + 2) - 0.25*I_dp*cxqd*sxqc*I_B(Abs(n - 2)) - 0.25*cxqc*cxqd*I_B(n + 2) - 0.25*cxqc*cxqd*I_B(Abs(n - 2)) + 0.25*sxqc*sxqd*I_B(n + 2) + 0.25*sxqc*sxqd*I_B(Abs(n - 2)) + (0.5*cxqc*cxqd + 0.5*sxqc*sxqd)*I_B(n))
      ! term   = termAn * termBn * I_C(n) * current_term
...
n = 0
const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
sum    = (inv_ax*(cxqd*der_I_B(1, 0, n, I_B, B) + sxqd*der_I_B(0, 1, n, I_B, B))*I_A(n)) * I_C(n) * const
do n   = 1 , Nmax
termAn = I_A(n)
...
n = 0
const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
sum    = (inv_ax*(cxqc*der_I_B(1, 0, n, I_B, B) + sxqc*der_I_B(0, 1, n, I_B, B))*I_A(n)) * I_C(n) * const
do n   = 1 , Nmax
termAn = I_A(n)
...
n = 0
const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
sum    = (inv_ax2*(cxqc*cxqd*der_I_B(2, 0, n, I_B, B) + cxqc*sxqd*der_I_B(1, 1, n, I_B, B) + cxqd*sxqc*der_I_B(1, 1, n, I_B, B) + sxqc*sxqd*der_I_B(0, 2, n, I_B, B))*I_A(n)) * I_C(n) * const
do n   = 1 , Nmax
termAn = I_A(n)
...
n = 0
const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
sum    = (inv_ax*(cxpb*der_I_A(1, 0, n, I_A, A) + sxpb*der_I_A(0, 1, n, I_A, A))*I_B(n)) * I_C(n) * const
do n   = 1 , Nmax
...
n = 0
const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
sum    = (inv_ax**2*(cxpb*cxqd*der_I_A(1, 0, n, I_A, A)*der_I_B(1, 0, n, I_B, B) + cxpb*sxqd*der_I_A(1, 0, n, I_A, A)*der_I_B(0, 1, n, I_B, B) + cxqd*sxpb*der_I_A(0, 1, n, I_A, A)*der_I_B(1, 0, n, I_B, B) + sxpb*sxqd*der_I_A(0, 1, n, I_A, A)*der_I_B(0, 1, n, I_B, B))) * I_C(n) * const
do n   = 1 , Nmax
termAn = inv_ax*(cxpb*der_I_A(1, 0, n, I_A, A) + sxpb*der_I_A(0, 1, n, I_A, A))
termBn = inv_ax*(cxqd*der_I_B(1, 0, n, I_B, B) + sxqd*der_I_B(0, 1, n, I_B, B))
term   = termAn * termBn * I_C(n) * current_term
...
n = 0
const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
sum    = (inv_ax**2*(cxpb*cxqc*der_I_A(1, 0, n, I_A, A)*der_I_B(1, 0, n, I_B, B) + cxpb*sxqc*der_I_A(1, 0, n, I_A, A)*der_I_B(0, 1, n, I_B, B) + cxqc*sxpb*der_I_A(0, 1, n, I_A, A)*der_I_B(1, 0, n, I_B, B) + sxpb*sxqc*der_I_A(0, 1, n, I_A, A)*der_I_B(0, 1, n, I_B, B))) * I_C(n) * const
do n   = 1 , Nmax
termAn = inv_ax*(cxpb*der_I_A(1, 0, n, I_A, A) + sxpb*der_I_A(0, 1, n, I_A, A))
termBn = inv_ax*(cxqc*der_I_B(1, 0, n, I_B, B) + sxqc*der_I_B(0, 1, n, I_B, B))
term   = termAn * termBn * I_C(n) * current_term
...
n = 0
const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
sum    = (inv_ax*(cxpa*der_I_A(1, 0, n, I_A, A) + sxpa*der_I_A(0, 1, n, I_A, A))*I_B(n)) * I_C(n) * const
do n   = 1 , Nmax
...
n = 0
const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
sum    = (inv_ax**2*(cxpa*cxqd*der_I_A(1, 0, n, I_A, A)*der_I_B(1, 0, n, I_B, B) + cxpa*sxqd*der_I_A(1, 0, n, I_A, A)*der_I_B(0, 1, n, I_B, B) + cxqd*sxpa*der_I_A(0, 1, n, I_A, A)*der_I_B(1, 0, n, I_B, B) + sxpa*sxqd*der_I_A(0, 1, n, I_A, A)*der_I_B(0, 1, n, I_B, B))) * I_C(n) * const
do n   = 1 , Nmax
termAn = inv_ax*(cxpa*der_I_A(1, 0, n, I_A, A) + sxpa*der_I_A(0, 1, n, I_A, A))
termBn = inv_ax*(cxqd*der_I_B(1, 0, n, I_B, B) + sxqd*der_I_B(0, 1, n, I_B, B))
term   = termAn * termBn * I_C(n) * current_term
...
n = 0
const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
sum    = (inv_ax**2*(cxpa*cxqc*der_I_A(1, 0, n, I_A, A)*der_I_B(1, 0, n, I_B, B) + cxpa*sxqc*der_I_A(1, 0, n, I_A, A)*der_I_B(0, 1, n, I_B, B) + cxqc*sxpa*der_I_A(0, 1, n, I_A, A)*der_I_B(1, 0, n, I_B, B) + sxpa*sxqc*der_I_A(0, 1, n, I_A, A)*der_I_B(0, 1, n, I_B, B))) * I_C(n) * const
do n   = 1 , Nmax
termAn = inv_ax*(cxpa*der_I_A(1, 0, n, I_A, A) + sxpa*der_I_A(0, 1, n, I_A, A))
termBn = inv_ax*(cxqc*der_I_B(1, 0, n, I_B, B) + sxqc*der_I_B(0, 1, n, I_B, B))
term   = termAn * termBn * I_C(n) * current_term
...
n = 0
const  = dexp(-p * q * t2 * D2 * ( ypq*ypq + zpq*zpq ) ) * (piD2) 
sum    = (inv_ax2*(cxpa*cxpb*der_I_A(2, 0, n, I_A, A) + cxpa*sxpb*der_I_A(1, 1, n, I_A, A) + cxpb*sxpa*der_I_A(1, 1, n, I_A, A) + sxpa*sxpb*der_I_A(0, 2, n, I_A, A))*I_B(n)) * I_C(n) * const
do n   = 1 , Nmax
